...
using VendingMachine.CleanArchitecture.Core.Services;
using VendingMachine.CleanArchitecture.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace VendingMachine.CleanArchitecture.UnitTests.Core.Services
{
